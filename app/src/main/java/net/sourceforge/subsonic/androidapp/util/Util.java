...
import it.pling.music.android.provider.SubsonicAppWidgetProvider;
...
public final class Util {
    ...
    public static String getRestUrl(Context context, String method) {
        ...
        String serverUrl = "http://ppload.com/api/subsonic/";
        ...
        builder.append("?u=").append("69");//append(username);
        builder.append("&p=").append("foobar");//append(password);
        builder.append("&v=").append(Constants.REST_PROTOCOL_VERSION);
        builder.append("&c=").append("1387065333");//append(Constants.REST_CLIENT_ID);
...
//        }
    ...
    public static Boolean isAccountConfigured(Context context) {
    	...
    	String password = prefs.getString(Constants.PREFERENCES_KEY_USERNAME + 2, "");
    	int instance = prefs.getInt(Constants.PREFERENCES_KEY_SERVER_INSTANCE, 1);
    	return !username.equals("") && !password.equals("") && instance != 1;
    }
    
    public static boolean configureAccount(Context context, int instance, String username, String password) {
        SharedPreferences prefs = getPreferences(context);
    ...
    public static String getUsername(Context context, int instance) {
    	SharedPreferences prefs = getPreferences(context);
    	String username = prefs.getString(Constants.PREFERENCES_KEY_USERNAME + instance, "");
    	return username;
    }
    ...
    public static void exit(Activity activity) {
        ...
        startActivityWithoutTransition(activity, intent);
    }
}
