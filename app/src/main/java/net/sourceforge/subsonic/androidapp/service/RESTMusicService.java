...
public class RESTMusicService implements MusicService {
    ...
    private static final int SOCKET_CONNECT_TIMEOUT = 100 * 1000;
    private static final int SOCKET_READ_TIMEOUT_DEFAULT = 100 * 1000;
    private static final int SOCKET_READ_TIMEOUT_DOWNLOAD = 300 * 1000;
    private static final int SOCKET_READ_TIMEOUT_GET_RANDOM_SONGS = 600 * 1000;
    private static final int SOCKET_READ_TIMEOUT_GET_PLAYLIST = 600 * 1000;
    ...
    private void detectRedirect(String originalUrl, Context context, HttpContext httpContext) {
        ...
        redirectFrom = originalUrl.substring(0, originalUrl.indexOf("/api/"));
        redirectTo = redirectedUrl.substring(0, redirectedUrl.indexOf("/api/"));
