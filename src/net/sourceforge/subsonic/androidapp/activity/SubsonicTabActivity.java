...
import com.runners_id.android.superampify.activity.AccountActivity;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_signout:
            	...
            	Util.setOffline(this, false);
            	
            	Intent accountActivity = new Intent(this, AccountActivity.class);
            	accountActivity.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
            	accountActivity.putExtra(Constants.INTENT_EXTRA_NAME_EXIT, true);
